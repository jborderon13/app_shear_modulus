...
with col1:
    ...
    USCS_CH = st.checkbox("USCS_CH", value=False, key="USCS_CH")
    USCS_CH_CL = st.checkbox("USCS_CH-CL", value=False, key="USCS_CH_CL")
    USCS_CL = st.checkbox("USCS_CL", value=False, key="USCS_CL")

with col2:
    USCS_CL_CH = st.checkbox("USCS_CL-CH", value=False, key="USCS_CL_CH")
    USCS_CL_ML = st.checkbox("USCS_CL-ML", value=False, key="USCS_CL_ML")
    USCS_MH = st.checkbox("USCS_MH", value=False, key="USCS_MH")
    USCS_MH_OH = st.checkbox("USCS_MH-OH", value=False, key="USCS_MH_OH")

with col3:
    USCS_ML = st.checkbox("USCS_ML", value=False, key="USCS_ML")
    USCS_ML_OL = st.checkbox("USCS_ML-OL", value=False, key="USCS_ML_OL")
